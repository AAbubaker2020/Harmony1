const translations = {
  en: {
    ...
    "Our Values.": ["Innovation", "Sustainability", "Integrity", "Excellence", "Collaboration"],
    ...
    Excellence: "تميز",
    Collaboration: "تعاون",
    "About Harmony Industrial Solutions": "عن حلول هارموني الصناعية",
    "Our Mission": "مهمتنا",
    "Our Vision": "رؤيتنا",
    "Our Values": "قيمنا",
    "Our Journey": "رحلتنا",
  ...
  ar: {
    "Our Mission.": "تقديم حلول صناعية مبتكرة ومستدامة تدفع التقدم وتحسن الحياة في جميع أنحاء العالم.",
    "Our Vision.": "أن نكون الرائد العالمي في التقنيات الصناعية التحويلية، ونشكل مستقبلاً أفضل للأجيال القادمة.",
    "Our Values.": ["ابتكار", "استدامة", "نزاهة", "تميز", "تعاون"],
    "Harmony Industrial Solutions was founded": "تأسست حلول هارموني الصناعية",
    "Expanded operations to 20 countries": "توسيع العمليات إلى 20 دولة",
    "Launched sustainable industrial solutions initiative": "إطلاق مبادرة الحلول الصناعية المستدامة",
    Innovation: "ابتكار",
    Sustainability: "استدامة",
    Integrity: "نزاهة",
    Excellence: "تميز",
